...
class _PostCardState extends State<PostCard3> {
  final List<String> imagesPost = [
    'assets/images/post/newjeans_offical.jpg',
  ];
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    radius: 20,
                    backgroundImage: AssetImage('assets/images/newjeans_official_av.jpg'),
                  ),
                  SizedBox(width: 10.0,),
                  Text("newjeans_official", style: TextStyle(fontSize: 18, fontFamily: 'Nunito')),
                ],
              ),
            ),
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('456.550 lượt thích', style: TextStyle(fontSize: 16,fontFamily: 'Nunito'),),
                  Text('NewJeans @ <Flaunt Magazine>', style: TextStyle(fontSize: 16,fontFamily: 'Nunito'),),
                  TextButton(
                      onPressed: () {
                      ...
                      child: const Text('Xem tất cả 809 bình luận', style: TextStyle(fontSize: 16,fontFamily: 'Nunito', color: Colors.grey))),
                  Text('22 GIỜ TRƯỚC', style: TextStyle(fontSize: 14,fontFamily: 'Nunito', color: Colors.grey),),
                ],
              ),
            )
